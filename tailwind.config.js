    ...
    extend: {
      ...
      keyframes: {
        ...
        waxGlow: {
          "0%, 100%": {
            boxShadow:
              "0 0 15px rgba(212, 175, 55, 0.4), inset 0 0 10px rgba(255, 255, 255, 0.3)",
          },
          "50%": {
            boxShadow:
              "0 0 30px rgba(212, 175, 55, 0.8), inset 0 0 18px rgba(255, 255, 255, 0.6)",
          },
        },
      },
      boxShadow: {
        envelope:
          "0 25px 50px -12px rgba(28, 25, 23, 0.18), 0 0 35px rgba(212, 175, 55, 0.12)",
        "envelope-deep":
          "0 35px 70px -15px rgba(0, 0, 0, 0.25), 0 0 45px rgba(212, 175, 55, 0.2)",
