...
export const EnvelopeOpening: React.FC<EnvelopeOpeningProps> = ({
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden z-20 select-none bg-[#2e0d18] flex items-center justify-center">
      {/* Full Viewport Close-Up Camera Container */}
      <motion.div
        className="relative w-full h-full max-w-lg mx-auto overflow-hidden bg-sage-texture-ref shadow-[0_35px_90px_rgba(0,0,0,0.35)] flex flex-col justify-between perspective-1200"
        ...
        transition={{
          duration: shouldReduceMotion ? 1.2 : 3.6,
          ease: [0.16, 1, 0.3, 1],
        }}
      >
        ...
        <motion.div
          ...
          animate={
            isOpening ? { x: "-100%", rotateY: -25 } : { x: "0%", rotateY: 0 }
          }
          transition={{
            duration: shouldReduceMotion ? 0.8 : 2.2,
            ease: [0.4, 0, 0.2, 1],
          }}
        >
          <svg
            className="w-full h-full drop-shadow-[8px_0_20px_rgba(0,0,0,0.5)]"
            viewBox="0 0 500 800"
            preserveAspectRatio="none"
          >
            {/* Left Diagonal Pocket Flap */}
            <polygon points="0,0 310,0 150,800 0,800" fill="#7c1d3b" />
            <line
              x1="310"
              y1="0"
              x2="150"
            ...
            <g
              className="embossed-high-relief"
              stroke="#7b3752"
              strokeWidth="2"
              fill="none"
              opacity="0.95"
            >
              ...
              <path
                d="M 60 180 C 40 140, 90 110, 120 150 C 150 110, 190 140, 170 180 C 210 210, 180 260, 130 240 C 100 270, 50 240, 70 200 Z"
                fill="#7c1d3b"
              />
              <circle
                cx="125"
                ...
                strokeWidth="1.5"
              />
              <circle cx="125" cy="185" r="8" fill="#6d1d36" />

              {/* Curving Vines & Leaves along Left Seam */}
              <path
                d="M -20 50 C 60 120, 100 280, 60 480 C 30 600, -20 720, -50 780"
                strokeWidth="2.8"
              />

              {/* Leaves branching left & right */}
              <path
                d="M 70 290 C 120 270, 160 300, 140 340 C 90 340, 70 310, 70 290 Z"
                fill="#7c1d3b"
              />
              <path
                d="M 50 380 C 100 360, 140 390, 120 430 C 70 430, 50 400, 50 380 Z"
                fill="#7c1d3b"
              />
              <path
                d="M 30 480 C 80 460, 120 490, 90 530 C 50 530, 30 500, 30 480 Z"
                fill="#7c1d3b"
              />

              {/* Lower 5-Petal Flower (Bottom Left) */}
              <path
                d="M 40 640 C 20 600, 70 570, 100 610 C 130 570, 170 600, 150 640 C 190 670, 160 720, 110 700 C 80 730, 30 700, 50 660 Z"
                fill="#7c1d3b"
              />
              <circle
                cx="105"
        ...
        >
          ...
          >
            ...
            <polygon points="310,0 500,0 500,800 150,800" fill="#732738" />
            <line
              x1="310"
              y1="0"
              x2="150"
            ...
            >
              ...
              <path
                d="M 370 100 C 350 60, 400 30, 430 70 C 460 30, 500 60, 480 100 C 520 130, 490 180, 440 160 C 410 190, 360 160, 380 120 Z"
                fill="#732738"
              />
              <circle
                cx="435"
              ...
              <path
                d="M 520 10 C 420 120, 380 300, 430 520 C 460 660, 520 740, 540 800"
                strokeWidth="2.6"
              />

              <path
                d="M 390 220 C 340 200, 310 240, 330 280 C 380 270, 400 240, 390 220 Z"
                fill="#732738"
              />
              <path
                d="M 410 320 C 360 300, 330 340, 350 380 C 400 370, 420 340, 410 320 Z"
                fill="#732738"
              />

              {/* Lower Right Blossom */}
              <path
                d="M 380 500 C 360 460, 410 430, 440 470 C 470 430, 510 460, 490 500 C 530 530, 500 580, 450 560 C 420 590, 370 560, 390 520 Z"
                fill="#732738"
              />
              <circle
                cx="445"
